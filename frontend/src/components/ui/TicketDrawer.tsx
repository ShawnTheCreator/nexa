        ...
        <div className="border-b border-gray-200 p-4 dark:border-gray-800">
          ...
          <div className="mt-4 space-y-4">
            <SummaryItem
              label="Type"
              value={
                ticketTypes.find((t: { value: any }) => t.value === formData.type)?.name ??
                undefined
              }
            />
            <SummaryItem
            ...
            <SummaryItem
              label="Policy Type"
              value={
                policyTypes.find((p: { value: any }) => p.value === formData.policyType)
                  ?.name ?? undefined
              }
            />
            <SummaryItem
              label="Priority"
              value={
                priorities.find((p: { value: any }) => p.value === formData.priority)?.label ??
                undefined
              }
            />
          </div>
