...
const stats = [
  {
    name: "Faster idea-to-project conversion",
    value: "3x",
  },
  {
...
export default function Features() {
  return (
    ...
    >
      <Badge>Innovation at Scale</Badge>
      <h2
        id="features-title"
        className="mt-2 inline-block bg-gradient-to-br from-gray-900 to-gray-800 bg-clip-text py-2 text-4xl font-medium tracking-tight text-transparent sm:text-6xl md:text-6xl dark:from-gray-50 dark:to-gray-300"
      >
        Designed for growth and impact
      </h2>
      <p className="mt-6 max-w-3xl text-lg leading-7 text-gray-600 dark:text-gray-400">
        Our platform streamlines how organisations capture, evaluate, and scale
        ideas. By removing bottlenecks and enabling real-time collaboration,
        teams unlock higher productivity and deliver outcomes faster — without
