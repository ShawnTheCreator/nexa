  ...
  const features = [
    {
      ...
      description:
        "Connect teams and innovators worldwide, allowing ideas to flow seamlessly.",
    },
    {
      name: "Automated Workflows",
      description:
        "Turn ideas into actionable projects with triggers and smart progress tracking.",
    },
    {
      name: "Insight & Analytics",
      description:
        "Gain transparency into idea development, monitor growth, and measure impact.",
    },
  ]
